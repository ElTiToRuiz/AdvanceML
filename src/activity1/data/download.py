# download.py
# ─────────────────────────────────────────────────────────────────────────────
# Step 1 of the Activity-1 data pipeline.
#
# Downloads raw OHLCV data for SPY, IEF and ^TNX from Yahoo Finance and
# saves each as a separate CSV in data/raw/.
#
...
def main() -> None:
    ...
    print()
    print(f"All raw files saved to {RAW_DIR}/")
